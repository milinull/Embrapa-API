...
class MongoDBLoaderFromS3:
    ...
    def load_parquet_to_mongodb(self, s3_path: str, collection_name: str, batch_size: int = 10000):
        """
        ...
        try:
            ...
            logger.info(f"Coleção '{collection_name}' preparada (dados anteriores removidos)")
