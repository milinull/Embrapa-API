...
class ComercVinhosViewSetTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.dados_teste = [
            ...
            ComercVinhos(
                Ano=2023, Categoria="Vinho Fino", Produto="Branco", Quantidade_L=500.75
            ),
            ComercVinhos(
                Ano=2024, Categoria="Vinho de Mesa", Produto="Rosé", Quantidade_L=750.25
            ),
        ]
    ...
    def test_filtros_combinados(self):
        ...
        response = self.client.get(
            self.url, {"ano": 2023, "categoria": "Vinho de Mesa"}
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        for item in response.data["results"]:
            self.assertEqual(item["Ano"], 2023)
...
class ProdVinhosViewSetTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.dados_teste = [
            ...
            ProdVinhos(
                Ano=2023, Categoria="Vinho Fino", Produto="Branco", Quantidade_L=10000.0
            ),
            ProdVinhos(
                Ano=2024, Categoria="Espumante", Produto="Brut", Quantidade_L=8000.0
            ),
        ]
...
class ProcessVinhosViewSetTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.dados_teste = [
            ...
            ProcessVinhos(
                Ano=2023, Tipo="Americanas", Cultivar="Isabel", Quantidade_Kg=8000.0
            ),
            ProcessVinhos(
                Ano=2024, Tipo="Viníferas", Cultivar="Merlot", Quantidade_Kg=10000.0
            ),
        ]
...
class ComparativoProducaoExportacaoTest(APITestCase):
    ...
    def setUp(self):
        ...
        ProdVinhos(
            Ano=2023, Categoria="Vinho de Mesa", Produto="Tinto", Quantidade_L=10000.0
        ).save()

        ProdVinhos(
            Ano=2023, Categoria="Vinho Fino", Produto="Branco", Quantidade_L=5000.0
        ).save()
